...
build:
	...
	i686-elf-as -32 isr0.s -o isr0.o
	...
	i686-elf-gcc -T linker.ld -o myos -ffreestanding -O2 -nostdlib \
		boot.o kernel.o terminal.o gdt.o gdtflush.o loadidt.o isr0.o -lgcc
...
clean:
	rm -rf boot.o isodir kernel.o myos myos.iso	terminal.o gdt.o gdtflush.o loadidt.o isr0.o
